...
import { newResult } from '../components/Result'


// encodeURI returns the exact search query for the user
...
export const blurb: any = [];
export const handleKey2 = (e: any, reset?: string): any => {
  if (e.key === 'Enter') {
    blurb.push(e.target.value);
    console.log(blurb[0])
    newResult(blurb[0]);
    e.stopPropagation();
  }
